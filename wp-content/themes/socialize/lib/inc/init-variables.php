	...
	function ghostpool_init_variables() {
		...
		if ( function_exists( 'bp_is_active' ) && ! bp_is_blog_page() ) {
			...
			if ( bp_is_user() ) {
				...
				$GLOBALS['ghostpool_left_sidebar'] = ghostpool_option( 'bp_members_right_sidebar' ) != 'default' ? ghostpool_option( 'bp_members_right_sidebar' ) : ghostpool_option( 'bp_left_sidebar' );
		...
		} elseif ( function_exists( 'is_woocommerce' ) && ( is_shop() OR is_product_category() OR is_product_tag() ) ) {
		...
		--------------------------------------------------------------*/
			...
			$GLOBALS['ghostpool_page_header'] = redux_post_meta( 'socialize', get_the_ID(), 'page_page_header' ) == 'default' ? $global['page_page_header'] : redux_post_meta( 'socialize', get_the_ID(), 'page_page_header' );
			
			$GLOBALS['ghostpool_page_header_bg'] = redux_post_meta( 'socialize', get_the_ID(), 'page_page_header_bg' );
						
			$GLOBALS['ghostpool_page_header_text'] = redux_post_meta( 'socialize', get_the_ID(), 'page_page_header_text' ) == '' ? $global['page_page_header_text'] : redux_post_meta( 'socialize', get_the_ID(), 'page_page_header_text' );
			...
			$global['page_layout'] : redux_post_meta( 'socialize', get_the_ID(), 'page_layout' );
			
			$GLOBALS['ghostpool_left_sidebar'] = redux_post_meta( 'socialize', get_the_ID(), 'page_left_sidebar' ) == 'default' ? $global['page_left_sidebar'] : 
			redux_post_meta( 'socialize', get_the_ID(), 'page_left_sidebar' );	
					
			$GLOBALS['ghostpool_right_sidebar'] = redux_post_meta( 'socialize', get_the_ID(), 'page_right_sidebar' ) == 'default' ? $global['page_right_sidebar'] : 
