...
if ( ! function_exists( 'ghostpool_scripts' ) ) {
	...
	function ghostpool_scripts() {
		...
		$custom_css .= '#gp-main-header {min-height:' . ghostpool_option( 'desktop_header_height', 'height' ) . 'px;}' . 

		'.gp-desktop-scrolling #gp-main-header {min-height:' . ghostpool_option( 'desktop_scrolling_header_height', 'height' ) . 'px;}' .
		...
		'@media only screen and (max-width: 1023px) {' .
			...
			'.gp-responsive #gp-main-header {min-height:' . ghostpool_option( 'mobile_header_height', 'height' ) . 'px;}' .
...
if ( ! function_exists( 'ghostpool_wp_header' ) ) {
	...
	function ghostpool_wp_header() {
		...
		echo '<!--[if gte IE 9]>.gp-slider-wrapper .gp-slide-caption + .gp-post-thumbnail:before,body:not(.gp-full-page-page-header) .gp-page-header.gp-has-text:before,body:not(.gp-full-page-page-header) .gp-page-header.gp-has-teaser-video.gp-has-text .gp-video-header:before{filter: none;}<![endif]-->';
