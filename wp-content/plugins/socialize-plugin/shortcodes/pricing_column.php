...
extract( shortcode_atts( array(
	'title'            => esc_html__( 'Column Title', 'socialize-plugin' ), 
	'highlight'        => 'disabled',
	'highlight_text' => '',
	'price'            => '',
	'currency_symbol'  => '',
...
<div class="gp-pricing-column <?php echo sanitize_html_class( $border_class ); ?>" style="background-color: <?php echo esc_attr( $bg_color ); ?>; border-color: <?php echo esc_attr( $border_color ); ?>; color: <?php echo esc_attr( $text_color ); ?>;">
